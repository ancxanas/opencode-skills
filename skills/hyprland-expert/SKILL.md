...
description: Configures and optimizes Hyprland Wayland compositor, including window rules, keybindings, animations, multi-monitor setup, companion tools (waybar, hyprlock, hypridle, hyprpaper), and troubleshooting. Use when setting up or customizing Hyprland, writing hyprland.conf, configuring window rules, creating keybindings, tuning animations, installing companion tools, or debugging Hyprland issues.
license: MIT
